...
function Signup() {
    return (
      ...
      <div class="grid md:grid-cols-3 items-center rounded-xl overflow-hidden">
  ...
  <img src={img} alt=""   />
        ...
        <form class="md:col-span-2 w-full py-6 px-6 sm:px-16">
          <div class="mb-6">
            <h3 class="text-[#704e81] text-2xl font-bold">Create an account</h3>
          </div>

          <div class="space-y-6">
            <div>
              <label class="text-[#704e81]  text-sm mb-2 block">Name</label>
            ...
            <div>
              <label class="text-[#704e81] text-sm mb-2 block">Email Id</label>
              <div class="relative flex items-center">
            ...
            <div>
              <label class="text-[#704e81]  text-sm mb-2 block">Password</label>
              <div class="relative flex items-center">
