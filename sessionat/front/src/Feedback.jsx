function Feedback() {
  ...
  <section id="testimonies" class="py-20 bg-[#fffffff] text-[#704e81]"> 
            ...
            <ul class="space-y-8 ">
                <li class="text-sm leading-6">
                    <div class="relative group ">
                        <div
                            class="bg-[#704e81] absolute transition rounded-lg opacity-25 -inset-1   blur duration-400 group-hover:opacity-100 group-hover:duration-200">
                        </div> 
                            <div
                                class="relative p-6 space-y-6 leading-none rounded-lg bg-[#704e81] ">
                                ...
                                <p class="leading-normal  text-md text-gray-300">Find God.</p>
                            </div>
                ...
                <li class="text-sm leading-6">
                    <div class="relative group">
                        <div
                            ...
                            <div
                                class="relative p-6 space-y-6 leading-none rounded-lg bg-[#704e81] ring-1 ring-gray-900/5">
                                <div class="flex items-center space-x-4"> 
                                    <div>
                                        <h3 class="text-lg font-semibold text-white">Kanye West</h3>
                                        <p class="text-gray-500 text-md">Rapper &amp; Entrepreneur</p>
